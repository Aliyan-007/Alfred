...
- 2026-09-14: Completed the targeted Android voice hardening and diagnostics pass. Read the project guidance and the relevant voice files first, then updated the service and wake/TTS flow in [AlfredAndroid/app/src/main/java/com/alfred/android/service/AlfredAgentService.kt](AlfredAndroid/app/src/main/java/com/alfred/android/service/AlfredAgentService.kt), [AlfredAndroid/app/src/main/java/com/alfred/android/voice/VoiceAssistant.kt](AlfredAndroid/app/src/main/java/com/alfred/android/voice/VoiceAssistant.kt), [AlfredAndroid/app/src/main/java/com/alfred/android/voice/wake/OpenWakeWordEngineAdapter.kt](AlfredAndroid/app/src/main/java/com/alfred/android/voice/wake/OpenWakeWordEngineAdapter.kt), [AlfredAndroid/app/src/main/java/com/alfred/android/voice/BritishVoiceSelection.kt](AlfredAndroid/app/src/main/java/com/alfred/android/voice/BritishVoiceSelection.kt), [AlfredAndroid/app/src/main/java/com/alfred/android/ui/dashboard/DashboardUiState.kt](AlfredAndroid/app/src/main/java/com/alfred/android/ui/dashboard/DashboardUiState.kt), and [AlfredAndroid/app/src/main/java/com/alfred/android/ui/dashboard/DashboardScreen.kt](AlfredAndroid/app/src/main/java/com/alfred/android/ui/dashboard/DashboardScreen.kt). Added concise wake/TTS diagnostics, microphone state reporting, and a small dashboard voice section without redesigning the app. Added deterministic tests in [AlfredAndroid/app/src/test/java/com/alfred/android/voice/wake/WakeWordAssetRequirementsTest.kt](AlfredAndroid/app/src/test/java/com/alfred/android/voice/wake/WakeWordAssetRequirementsTest.kt). Verified `:app:testDebugUnitTest` and `:app:assembleDebug` succeed, and inspected the generated APK at [AlfredAndroid/app/build/outputs/apk/debug/app-debug.apk](AlfredAndroid/app/build/outputs/apk/debug/app-debug.apk). The APK includes the required assets `alfred.onnx`, `melspectrogram.onnx`, and `embedding_model.onnx`. Real-device wake detection, command recognition, British TTS playback, and full voice-loop validation remain `MANUAL` because no physical Android handset was available during this session.
