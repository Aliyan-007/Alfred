...
data class CapabilityStatus(val id: String, val displayName: String, val state: CapabilityState)
data class PermissionStatus(val name: String, val granted: Boolean, val note: String? = null)
